 ...
 - [Questions](#questions)
  ...
  The main challenges in developing this application were familiarisation with Node and Inquirer and the idiosyn
  ...
  ## Installation
  Ensure node is installed - test by running node -v.
